 ...
 * XtraBackup<br>
 * 
 * XtraBackup: Implements MySQL hot backups with innobackupex command<br><br>
 * 
 ...
 */
public class XtraBackup extends Backup {
	/**
	 ...
	 */
	public XtraBackup(Properties config) {
		this._config = config;
	}
	...
	/**
	 * Execute backup with innobackupex<br><br>
	 * 
	 * Notes: innobackupex must be accessible<br><br>
	 * 
	...
	public boolean backup(String fileName) {
		...
		StringBuffer command = new StringBuffer("innobackupex");
